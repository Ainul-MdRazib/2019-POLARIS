...
public class TestMyLampActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emoji.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TestMyLampActivity.this, TestUsingEmoji.class));
                finish();
            }
        });
        ...
        palette.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TestMyLampActivity.this, TestUsingPalette.class));
                finish();
            }
        });
